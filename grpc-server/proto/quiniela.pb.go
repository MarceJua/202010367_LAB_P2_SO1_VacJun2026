...
func (Teams) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_quiniela_proto_enumTypes[0].Descriptor()
}

func (Teams) Type() protoreflect.EnumType {
	return &file_proto_quiniela_proto_enumTypes[0]
}
...
func (Teams) EnumDescriptor() ([]byte, []int) {
	return file_proto_quiniela_proto_rawDescGZIP(), []int{0}
}
...
func (x *MatchPredictionRequest) Reset() {
	*x = MatchPredictionRequest{}
	mi := &file_proto_quiniela_proto_msgTypes[0]
...
func (x *MatchPredictionResponse) Reset() {
	*x = MatchPredictionResponse{}
	mi := &file_proto_quiniela_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MatchPredictionResponse) Descriptor() ([]byte, []int) {
	return file_proto_quiniela_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_quiniela_proto protoreflect.FileDescriptor

const file_proto_quiniela_proto_rawDesc = "" +
	"\n" +
	"\x14proto/quiniela.proto\x12\fworldcup2026\"\xf4\x01\n" +
...
var (
	file_proto_quiniela_proto_rawDescOnce sync.Once
	file_proto_quiniela_proto_rawDescData []byte
)

func file_proto_quiniela_proto_rawDescGZIP() []byte {
	file_proto_quiniela_proto_rawDescOnce.Do(func() {
		file_proto_quiniela_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_quiniela_proto_rawDesc), len(file_proto_quiniela_proto_rawDesc)))
	})
	return file_proto_quiniela_proto_rawDescData
}

var file_proto_quiniela_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_quiniela_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_quiniela_proto_goTypes = []any{
...
var file_proto_quiniela_proto_depIdxs = []int32{
...
func init() { file_proto_quiniela_proto_init() }
func file_proto_quiniela_proto_init() {
	if File_proto_quiniela_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_quiniela_proto_rawDesc), len(file_proto_quiniela_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_quiniela_proto_goTypes,
		DependencyIndexes: file_proto_quiniela_proto_depIdxs,
		EnumInfos:         file_proto_quiniela_proto_enumTypes,
		MessageInfos:      file_proto_quiniela_proto_msgTypes,
	}.Build()
	File_proto_quiniela_proto = out.File
	file_proto_quiniela_proto_goTypes = nil
	file_proto_quiniela_proto_depIdxs = nil
}
